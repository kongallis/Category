                ...
                <div class="row">
                 ...
                 <div class="row">
                    <div class="form-group col-md-12">
                        ...
                        <div class="col-md-7">
                            <form:input type="text" path="categoryId.id" class="form-control input-sm" maxlength="45"/>
                        </div>
                    </div>
                </div>        
                <div class="row">
                    <div class="form-group col-md-12">
                        ...
                        <div class="col-md-7">
                            <form:input type="text" path="measurementId.id" class="form-control input-sm" maxlength="45"/>
                        </div>
                    </div>
                </div>
