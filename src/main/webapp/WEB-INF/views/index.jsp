                    ...
                    <tbody>
                        <c:forEach items="${products}" var="product">
                            <tr>
                                ...
                                <td><a href="<c:url value='/edit/${product.id}' />" class="btn btn-warning custom-width">Edit</a></td>
                                <td><a href="<c:url value='/delete/${product.id}' />" class="btn btn-danger custom-width">Delete</a></td>
